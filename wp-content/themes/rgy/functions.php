...
function rgy_setup() {
	 ...
	 * If you're building a theme based on rgy, use a find and replace
	 * to change 'rgy' to the name of your theme in all the template files.
	 */
	...
	add_theme_support( 'custom-background', apply_filters( 'rgy_custom_background_args', array(
